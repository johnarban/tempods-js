<template>
  <div class="comparison-data-controls">
    ...
    >
      <layer-order-control
        :mapRef="map"
        :order="['power-plants-layer', 'aqi-layer-aqi', 'pop-dens', 'land-use', 'pace-chlor', 'pace-color', 'pace-dirt','hms-fire', 'tempo-o3', 'tempo-hcho', 'tempo-no2', 'stamen-toner-lines', 'stamen-toner-labels']"
      >
      </layer-order-control>
