<template>
  <div class="comparison-data-controls">
    ...
    >
      <layer-order-control
        :mapRef="map"
        :order="['power-plants-layer', 'places-asthma-layer', 'aqi-layer-aqi', 'pop-dens', 'land-use','hms-fire', 'tempo-o3', 'tempo-hcho', 'tempo-no2', 'stamen-toner-lines', 'stamen-toner-labels']"
      >
      </layer-order-control>
